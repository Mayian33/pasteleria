...
<body>
    ...
    <section class="main">
        <section>
            <h1 class="subtitle-text">POLÍTICA DE COOKIES</h1>
            <b class="common-text">POLÍTICA DE COOKIES</b>
            <div class="common-text">
                <p>Si quieres saber más sobre el uso de cookies que realiza este sitio web (https://pasteleria.cupcakesytartas.com/), estás en el lugar indicado.</p>
                <p>A continuación, vamos a explicarte qué son exactamente las cookies; qué tipo de cookies utilizamos y para qué; y cómo puedes ejercer tu derecho para configurar tu navegador y desestimar el uso de cualquiera de ellas.</p>
        ...
        <section>
            <b class="common-text">QUÉ ES UNA COOKIE</b>
            <div class="common-text">
                ...
                <p>Las cookies se asocian al navegador, no a la persona, por lo que no suelen almacenar información sensible sobre ti como tarjetas de crédito o datos bancarios, fotografías o información personal, etc.</p>
                <p>Los datos que guardan son de carácter técnico, estadísticos, preferencias personales, personalización de contenidos, etc.</p>
            </div>
        </section>
        ...
        <section>
            <b class="common-text">ACEPTACIÓN DE LAS COOKIES: NORMATIVA VIGENTE</b>
            <div class="common-text">
        ...
        <section>
            <b class="common-text">TIPOS DE COOKIES</b>
            <div class="common-text">
                <p>Para poder ofrecerte una mejor experiencia de usuario, obtener datos analíticos, almacenar y recuperar información sobre tus hábitos de navegación o de tu equipo y desarrollar su actividad, este sitio web (https://pasteleria.cupcakesytartas.com/), utiliza cookies propias y de terceros.</p>
        ...
        <section>
            <b class="common-text">GESTIONAR Y RECHAZAR EL USO DE COOKIES</b>
            <div class="common-text">
                ...
                <p>Google Chrome <a href="https://support.google.com/chrome/answer/95647?hl=es-419" target="_blank">https://support.google.com/chrome/answer/95647?hl=es-419</a></p>
                <p>Internet Explorer <a href="https://support.microsoft.com/es-es/help/17442/windows-internet-explorer-delete-manage-cookies#ie=ie-10" target="_blank">https://support.microsoft.com/es-es/help/17442/windows-internet-explorer-delete-manage-cookies#ie=ie-10</a></p>
                <p>Mozilla Firefox <a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias?redirectlocale=es&redirectslug=habilitar-y-deshabilitar-cookies-que-los-sitios-we" target="_blank">https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias?redirectlocale=es&redirectslug=habilitar-y-deshabilitar-cookies-que-los-sitios-we</a></p>
                <p>Apple Safari <a href="https://support.apple.com/es-es/HT201265" target="_blank">https://support.apple.com/es-es/HT201265</a></p>
                <p>Si tienes cualquier duda sobre esta Política de Cookies, puedes contactar con nosotros enviándonos un mail a <a href="mailto:contacto@cupcakesytartas.com">contacto@cupcakesytartas.com</a>.</p>
            </div>
        </section>
