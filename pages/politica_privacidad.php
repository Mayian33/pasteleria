...
<body>
    ...
    <section class="main">
        ...
        <section>
            ...
            <b class="common-text">POLÍTICA DE PRIVACIDAD</b>
            <div class="common-text">
                <p>
                <p> Si estás aquí es porque quieres saber más sobre las obligaciones y derechos que te corresponden como usuario de esta web (https://pasteleria.cupcakesytartas.com/) y eso está muy bien. Nuestro deber es informarte y el tuyo estar debidamente informado.
                </p>
                <p> En esta Política de Privacidad te informaremos con total transparencia sobre la finalidad de este sitio web y todo lo que afecta a los datos que nos facilites, así como de las obligaciones y derechos que te corresponden.
                </p>
                ...
                <p> Concretamente, esta web se ajusta al cumplimiento de las siguientes normativas:
                </p>
                <p> El RGPD (Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016 relativo a la protección de las personas físicas) que es la nueva normativa de la Unión Europea que unifica la regulación del tratamiento de los datos personales en los distintos países de la UE.
                </p>
                ...
                <p> La LSSI (Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y Comercio Electrónico) que regula las transacciones económicas mediante medios electrónicos, como es el caso de este blog.
                </p>
                </p>
            </div>
        </section>
        ...
        <section>
            <b class="common-text">CONDICIONES DE USO</b>
            <div class="common-text">
        ...
        <section>
            <b class="common-text">REGISTRO Y FINALIDAD DE TUS DATOS</b>
            <div class="common-text">
                <p>En función del formulario o sección a la que accedas, te solicitaremos exclusivamente los datos necesarios con las finalidades descritas a continuación.</p>
                <p>En todo momento, deberás dar tu consentimiento expreso, cuando te solicitemos información personal con las siguientes finalidades:</p>
                ...
                <p>De ser así, te garantizamos que estos terceros nunca tendrán acceso a tus datos personales, con las excepciones reflejadas a continuación, siendo en todo caso estas comunicaciones realizadas por parte de CRP, como titular de la web.</p>
        ...
        <section>
            <b class="common-text">EXACTITUD Y VERACIDAD DE LOS DATOS</b>
            <div class="common-text">
                <p>Como usuario, eres el único responsable de la veracidad y modificación de los datos que remitas a CRP, exonerándonos de cualquier responsabilidad al respecto.</p>
        ...
        <section>
            <b class="common-text">BAJAS DE SUSCRIPCIÓN Y DERECHO DE REVOCACIÓN</b>
            <div class="common-text">
                <p>Como titular de los datos que nos hayas facilitado, podrás ejercer en cualquier momento tus derechos de acceso, rectificación, cancelación y oposición, enviándonos un correo electrónico a driveyourseo@gmail.com y adjuntándonos una fotocopia de tu documento de identidad como prueba válida.</p>
                <p>Igualmente, podrás darte de baja en cualquier momento para dejar de recibir nuestra newsletter o cualquier otra comunicación comercial, directamente desde el mismo email que hayas recibido o enviándonos un correo a driveyourseo@gmail.com.</p>
            </div>
        </section>

        <section>
            <b class="common-text">ACCESO A DATOS POR CUENTA DE TERCEROS</b>
            <div class="common-text">
        ...
        <section>
            <b class="common-text">Google Analytics:</b>
            <div class="common-text">
        ...
        <section>
            <b class="common-text">Google Adsense:</b>
            <div class="common-text">
        ...
        <section>
            <b class="common-text">MEDIDAS DE SEGURIDAD</b>
            <div class="common-text">
                <p>Como titular de la web, CRP ha adoptado todas las medidas técnicas y de organización necesaria para garantizar la seguridad e integridad de los datos de carácter personal que trate, así como para evitar su pérdida, alteración y/o acceso por parte de terceros no autorizados.</p>
